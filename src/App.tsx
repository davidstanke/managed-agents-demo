...
export const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50/70 via-orange-50/30 to-amber-100/40 dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col font-sans transition-colors duration-150">
      <Header
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-8">
        ...
        <section className="bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-rose-500/10 dark:from-slate-900/90 dark:via-slate-900/80 dark:to-slate-900/90 border border-amber-200/90 dark:border-slate-800 rounded-3xl p-6 sm:p-8 backdrop-blur-sm shadow-sm flex flex-col md:flex-row items-center gap-6 md:gap-8 justify-between">
          <div className="space-y-3 max-w-xl text-center md:text-left">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-100 dark:bg-orange-950/50 border border-orange-200 dark:border-orange-800/60 text-orange-800 dark:text-orange-300 text-xs font-bold shadow-xs">
      ...
      {/* Footer */}
      <footer className="border-t border-amber-200/80 dark:border-slate-800 bg-white/60 dark:bg-slate-900/80 backdrop-blur-sm py-6 text-center text-xs text-slate-500 dark:text-slate-400">
