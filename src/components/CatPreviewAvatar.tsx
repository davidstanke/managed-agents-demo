...
export const CatPreviewAvatar: React.FC<CatPreviewAvatarProps> = ({ coat, personalities }) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center p-4 bg-white/70 dark:bg-slate-900/80 backdrop-blur-md rounded-2xl border border-amber-200/80 dark:border-slate-800 shadow-sm">
      ...
      <div className="mt-2 text-center">
        <span className="inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full bg-amber-100 dark:bg-amber-950/60 text-amber-900 dark:text-amber-300">
