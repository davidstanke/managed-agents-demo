...
def get_maintainability_config() -> LocalAgentConfig:
    use_vertex = (
    ...
    return LocalAgentConfig(
        system_instructions=load_prompt("maintainability"),
...
def create_maintainability_agent() -> Agent:
    return Agent(config=get_maintainability_config())
