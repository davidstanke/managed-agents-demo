...
def get_clean_code_config() -> LocalAgentConfig:
    use_vertex = (
    ...
    return LocalAgentConfig(
        system_instructions=load_prompt("clean_code"),
...
def create_clean_code_agent() -> Agent:
    return Agent(config=get_clean_code_config())
