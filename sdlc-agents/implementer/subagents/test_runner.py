...
def get_test_runner_config() -> LocalAgentConfig:
    use_vertex = (
    ...
    return LocalAgentConfig(
        system_instructions=load_prompt("test_runner"),
...
def create_test_runner_agent() -> Agent:
    return Agent(config=get_test_runner_config())
