...
- **Branch Checkout**: Prior to writing the specification file to disk:
  ...
  2. Create and check out a new branch named `feature/<feature-slug>` based on the feature being specified (e.g., `git checkout -b feature/<feature-slug>` or `git checkout feature/<feature-slug>` if the branch already exists).
